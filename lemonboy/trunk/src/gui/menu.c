...
#define MACHINE_ITEMS 4
	...
	char *cpu_opts[CPU_OPTS_ITEMS]={
		...
		"Clock 200MHz", "Clock 225MHz", "Clock 250MHz",
		"Clock 275MHz", "Clock 300MHz", "Clock 325MHz"}
	int cpu_values[CPU_OPTS_ITEMS]={
		100, 125, 133, 150, 166, 175, 200, 225, 250, 275, 300, 325};
#endif
